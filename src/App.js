...
function App() {
  ...
  <Route path='fitness-treadmill' element={<Treadmill/>}/>
  ...
  <Route path='fitness-allEquipment-outofstock' element={<ViewAllOutOfStock/>}/>
  <Route path='cross-trainer-outofstock' element={<CrossOutOfStock/>}/>
  <Route path='cross-treadmill-outofstock' element={<TreadMillOutOfStock/>}/>
  <Route path='cross-massager-outofstock' element={<MassagerOutOfStock/>}/>
  <Route path='cross-trainer-outofstock' element={<CrossOutOfStock/>}/>
