        ...
        {img.map((value, index) => {
          return (
            <div className="equipment-card-design-massager" key={index}>
              ...
              <img src={value.img} className="equipment-pro-img-massager" />
              <br></br>
              <div className="equipment-header-massager">
                <p className="-name-massager">{value.productname}</p>
                <br></br>
              ...
              <Link
                ...
                to={`/portal/massager/${value._id}`}
                className="equipments-card-btn"
              >
                Quick View
              </Link>
            </div>
